...
Generate content for section `section-07-integration` (filename: `section-07-integration.md`).
...
for `section-07-integration` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-07-integration.md`
