...
Generate content for section `section-05-plugin-main` (filename: `section-05-plugin-main.md`).
...
for `section-05-plugin-main` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-05-plugin-main.md`
