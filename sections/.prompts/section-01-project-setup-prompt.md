...
Generate content for section `section-01-project-setup` (filename: `section-01-project-setup.md`).
...
for `section-01-project-setup` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-01-project-setup.md`
