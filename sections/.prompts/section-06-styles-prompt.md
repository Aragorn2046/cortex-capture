...
Generate content for section `section-06-styles` (filename: `section-06-styles.md`).
...
for `section-06-styles` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-06-styles.md`
