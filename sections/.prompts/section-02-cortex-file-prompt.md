...
Generate content for section `section-02-cortex-file` (filename: `section-02-cortex-file.md`).
...
for `section-02-cortex-file` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-02-cortex-file.md`
