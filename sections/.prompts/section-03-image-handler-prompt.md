...
Generate content for section `section-03-image-handler` (filename: `section-03-image-handler.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/aragorn/projects/cortex-capture/01-cortex-capture/claude-plan.md` - Full implementation plan
2. `/Users/aragorn/projects/cortex-capture/01-cortex-capture/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-image-handler` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-03-image-handler.md`
