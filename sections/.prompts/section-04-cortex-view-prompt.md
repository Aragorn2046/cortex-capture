...
Generate content for section `section-04-cortex-view` (filename: `section-04-cortex-view.md`).
...
for `section-04-cortex-view` to understand what this section should contain.
...
`/Users/aragorn/projects/cortex-capture/01-cortex-capture/sections/section-04-cortex-view.md`
